...
contract LiquidityExamples is IERC721Receiver{
    ...
    //implementing onERC721Received so this contract can receieve the custody of token
    ...
    function mintNewPosition() external returns (uint _tokenId, uint128 liquidity, uint amount0, uint amount1){
        //will provide equal amount of liquidity in both assets.
        uint amount0ToMint = 100 * 1e18;
                ...
                INonfungiblePositionManager.MintParams memory params = INonfungiblePositionManager.MintParams({
                    ...
                    token1 : USDC,
                    fee : poolFee,
                    //By using TickMath Min and MAx we are providing liquidity accross the whole range of the pool
    ...
    function collectAllFees() external returns(uint256 amount0, uint amount1){
